...
def format_ajuste_promedio_message(result):
    ...
    return (
        ...
        f"Si algo no cierra, mandá \"/deshacer\" para revertir este ajuste."
    )
...
def format_confirmacion_message(result):
    ...
    if result["tipo"] == "margen_extra":
        return (
            ...
            f"Si algo no cierra, mandá \"/deshacer\" para revertir esta última carga."
        )
...
def format_cierre_message(result):
    ...
    return (
        ...
        f"Confirmá el resultado real en el exchange. Para arrancar de nuevo: "
        f"\"/saylor_iniciar <capital_total>\"."
    )
